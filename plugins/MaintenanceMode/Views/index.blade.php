        ...
        <div class="page-body">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form action="{{ route('admin.plugin.maintenance-mode.update') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <label class="row">
                                                <span class="col">{{ __('Enable maintenance mode?') }}</span>
                                                <span class="col-auto">
                                                    <label class="form-check form-check-single form-switch">
                                                        <input name="maintenance_mode" class="form-check-input"
                                                            type="checkbox"

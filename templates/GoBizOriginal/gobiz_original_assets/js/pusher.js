var PusherPushNotifications = (function (exports) {
    ...
    var INTERESTS_REGEX = new RegExp(
        "^(_|\\-|=|@|,|\\.|;|[A-Z]|[a-z]|[0-9])*$"
    );
    var MAX_INTEREST_LENGTH = 164;
    var MAX_INTERESTS_NUM = 5000;
    var SERVICE_WORKER_URL =
        "/service-worker.js?pusherBeamsWebSDKVersion=".concat(version);
        ...
        (function () {
            function Client(config) {
                ...
                var instanceId = config.instanceId,
                    ...
                    endpointOverride =
                        _config$endpointOverr === void 0
                            ? null
                            : _config$endpointOverr,
                    _config$serviceWorker = config.serviceWorkerRegistration,
                    serviceWorkerRegistration =
                        _config$serviceWorker === void 0
                            ? null
                            : _config$serviceWorker;
                ...
                if (serviceWorkerRegistration) {
                    ...
                    var scopeMatchesCurrentPage =
                        currentURL.startsWith(serviceWorkerScope);

                    if (!scopeMatchesCurrentPage) {
                        throw new Error(
                            "Could not initialize Pusher web push: current page not in serviceWorkerRegistration scope (".concat(
                                serviceWorkerScope,
                                ")"
                            )
                        );
                ...
                },
                {
                    ...
                    value: (function () {
                        ...
                        function _detectSubscriptionChange() {
                            return _detectSubscriptionChange2.apply(
                                this,
                                arguments
                            );
                        }
                    ...
                    value: function _throwIfNotStarted(message) {
                        if (!this._deviceId) {
                            throw new Error(
                                "".concat(
                                    message,
                                    ". SDK not registered with Beams. Did you call .start?"
                                )
                            );
                        }
                    },
                                        ...
                                        while (1) {
                                            switch (
                                                ...
                                                case 15:
                                                    ...
                                                    _context7.next = 18;
                                                    return this._deviceStateStore.setToken(
                                                        token
                                                    );

                                                case 18:
                                                    _context7.next = 20;
                                                    return this._deviceStateStore.setDeviceId(
                                                        deviceId
                                                    );

                                                case 20:
                                                    _context7.next = 22;
                                                    return this._deviceStateStore.setLastSeenSdkVersion(
                                                        version
                                                    );

                                                case 22:
                                                    _context7.next = 24;
                                                    return this._deviceStateStore.setLastSeenUserAgent(
                                                        window.navigator
                                                            .userAgent
                                                    );
                                    ...
                                    function _callee9$(_context9) {
                                        while (1) {
                                            switch (
                                                ...
                                                case 2:
                                                    this._throwIfNotStarted(
                                                        "Could not add Device Interest"
                                                    );
                                    ...
                                    function _callee10$(_context10) {
                                        while (1) {
                                            switch (
                                                ...
                                                case 2:
                                                    this._throwIfNotStarted(
                                                        "Could not remove Device Interest"
                                                    );
                                    ...
                                    function _callee11$(_context11) {
                                        while (1) {
                                            switch (
                                                ...
                                                case 2:
                                                    this._throwIfNotStarted(
                                                        "Could not get Device Interests"
                                                    );
                                    ...
                                    function _callee12$(_context12) {
                                        while (1) {
                                            switch (
                                                ...
                                                case 2:
                                                    this._throwIfNotStarted(
                                                        "Could not set Device Interests"
                                                    );
                                    ...
                                    function _callee13$(_context13) {
                                        while (1) {
                                            switch (
                                                ...
                                                case 2:
                                                    this._throwIfNotStarted(
                                                        "Could not clear Device Interests"
                                                    );
                                        ...
                                        while (1) {
                                            switch (
                                                ...
                                                case 4:
                                                    ...
                                                    error = new Error(
                                                        ".start must be called before .setUserId"
                                                    );
                                                    return _context14.abrupt(
                                                        "return",
                                                ...
                                                case 7:
                                                    ...
                                                    throw new Error(
                                                        "User ID must be a string (was ".concat(
                                                            userId,
                                                            ")"
                                                        )
                                                    );
                                                ...
                                                case 9:
                                                    ...
                                                    throw new Error(
                                                        "User ID cannot be the empty string"
                                                    );
                                                ...
                                                case 21:
                                                    ...
                                                    return _context14.abrupt(
                                                        "return",
                                                        this._deviceStateStore.setUserId(
                                                            userId
                                                        )
                                                    );
                                    ...
                                    function _callee15$(_context15) {
                                        while (1) {
                                            switch (
                                                ...
                                                case 10:
                                                    this._clearPushToken()[
                                                        "catch"
                                                    ](function () {}); // Not awaiting this, best effort.
                    ...
                    value: (function () {
                        var _clearPushToken2 = asyncToGenerator(
                            ...
                            regenerator.mark(function _callee19() {
                                return regenerator.wrap(function _callee19$(
                                    _context19
                                ) {
                                    while (1) {
                                        switch (
                ...
                },
                {
                    ...
                    value: (function () {
                        ...
                        function _updateDeviceMetadata() {
                            return _updateDeviceMetadata2.apply(
                                this,
                                arguments
                            );
                        }
    ...
    var validateInterestName = function validateInterestName(interest) {
        ...
        if (interest.length > MAX_INTEREST_LENGTH) {
            throw new Error(
                "Interest is longer than the maximum of ".concat(
                    MAX_INTEREST_LENGTH,
                    " chars"
                )
            );
    ...
    function urlBase64ToUInt8Array(base64String) {
        ...
        return Uint8Array.from(
            toConsumableArray(rawData).map(function (_char) {

@extends('GoBizOriginal::Website.layouts.index', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('About us')])
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-full mx-auto mb-20">
                <h2 class="mb-4 font-heading font-semibold text-center text-6xl sm:text-7xl text-gray-900 break-words">
                    {{ __($aboutPage[0]->section_content) }}</h2>
            </div>
            <div class="flex flex-wrap -m-6">
                @if (
                    !empty($aboutPage[1]->section_content) &&
                        !empty($aboutPage[2]->section_content) &&
                        !empty($aboutPage[3]->section_content) &&
                        !empty($aboutPage[4]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($aboutPage[1]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($aboutPage[5]->section_content) &&
                        !empty($aboutPage[6]->section_content) &&
                        !empty($aboutPage[7]->section_content) &&
                        !empty($aboutPage[8]->section_content) &&
                        !empty($aboutPage[9]->section_content) &&
                        !empty($aboutPage[10]->section_content) &&
                        !empty($aboutPage[11]->section_content) &&
                        !empty($aboutPage[12]->section_content) &&
                        !empty($aboutPage[13]->section_content) &&
                        !empty($aboutPage[14]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($aboutPage[5]->section_content) }}</h2>

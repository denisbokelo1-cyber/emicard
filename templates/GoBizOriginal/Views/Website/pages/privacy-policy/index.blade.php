@extends('GoBizOriginal::Website.layouts.index', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('Privacy Policy')])
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-full mx-auto mb-20">
                <h2 class="mb-4 font-heading font-semibold text-center text-6xl sm:text-7xl text-gray-900 break-words">
                    {{ __($privacyPage[0]->section_content) }}</h2>
            </div>
            <div class="flex flex-wrap -m-6 mb-12">
                @if (
                    !empty($privacyPage[1]->section_content) &&
                        !empty($privacyPage[2]->section_content) &&
                        !empty($privacyPage[3]->section_content))
                ...
                @endif
                @if (!empty($privacyPage[4]->section_content) && !empty($privacyPage[5]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[4]->section_content) }}</h2>
                            <p class="text-base text-black mb-3">{{ __($privacyPage[5]->section_content) }}</p>
                        </div>
                    </div>
                @endif
                @if (
                    !empty($privacyPage[6]->section_content) &&
                        !empty($privacyPage[7]->section_content) &&
                        !empty($privacyPage[8]->section_content) &&
                        !empty($privacyPage[9]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[6]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($privacyPage[10]->section_content) &&
                        !empty($privacyPage[11]->section_content) &&
                        !empty($privacyPage[12]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[10]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($privacyPage[13]->section_content) &&
                        !empty($privacyPage[14]->section_content) &&
                        !empty($privacyPage[15]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[13]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($privacyPage[16]->section_content) &&
                        !empty($privacyPage[17]->section_content) &&
                        !empty($privacyPage[18]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[16]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($privacyPage[19]->section_content) &&
                        !empty($privacyPage[20]->section_content) &&
                        !empty($privacyPage[21]->section_content) &&
                        !empty($privacyPage[22]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[19]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($privacyPage[23]->section_content) &&
                        !empty($privacyPage[24]->section_content) &&
                        !empty($privacyPage[25]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[23]->section_content) }}</h2>
                ...
                @endif
                @if (
                    !empty($privacyPage[26]->section_content) &&
                        !empty($privacyPage[27]->section_content) &&
                        !empty($privacyPage[28]->section_content) &&
                        !empty($privacyPage[29]->section_content) &&
                        !empty($privacyPage[30]->section_content) &&
                        !empty($privacyPage[31]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[26]->section_content) }}</h2>
                            <p class="text-base text-black mb-4">
                                <strong>{{ __($privacyPage[27]->section_content) }}</strong>
                            </p>
                ...
                @endif
                @if (
                    !empty($privacyPage[32]->section_content) &&
                        !empty($privacyPage[33]->section_content) &&
                        !empty($privacyPage[34]->section_content) &&
                        !empty($privacyPage[35]->section_content) &&
                        !empty($privacyPage[36]->section_content) &&
                        !empty($privacyPage[37]->section_content) &&
                        !empty($privacyPage[38]->section_content) &&
                        !empty($privacyPage[39]->section_content) &&
                        !empty($privacyPage[40]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[32]->section_content) }}</h2>
                            <p class="text-base text-black mb-4">
                                <strong>{{ __($privacyPage[33]->section_content) }}</strong>
                            </p>
                ...
                @endif
                @if (
                    !empty($privacyPage[41]->section_content) &&
                        !empty($privacyPage[42]->section_content) &&
                        !empty($privacyPage[43]->section_content))
                    <div class="w-full p-6">
                        <div class="md:max-w-full">
                            <h2 class="mb-4 font-heading font-medium text-2xl text-gray-900 break-words">
                                {{ __($privacyPage[41]->section_content) }}</h2>

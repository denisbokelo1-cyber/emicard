@extends('GoBizOriginal::Website.layouts.index', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('Contact us')])
            ...
            <div class="flex flex-wrap -m-6">
                ...
                <div class="w-full md:w-1/3 p-6">
                    <div class="md:max-w-xs">
                        ...
                        <p class="text-lg text-gray-700"><a
                                href="mailto:{{ __($contactPage[6]->section_content) }}">{{ __($contactPage[6]->section_content) }}</a>
                        </p>
                        <p class="text-lg text-gray-700"><a
                                href="tel:{{ __($contactPage[7]->section_content) }}">{{ __($contactPage[7]->section_content) }}</a>
                        </p>
                    </div>
                </div>
                <div class="w-full md:w-1/3 p-6">
                    <div class="md:max-w-xs">
                        ...
                        <div class="flex flex-wrap items-center -ml-5">
                            @if (!empty($supportPage[0]->section_content) && $supportPage[0]->section_content !== '#')
                                <div class="w-auto p-5">
                                    <a class="text-gray-900" href="{{ __($supportPage[0]->section_content) }}"
                                        target="_blank">
                            ...
                            @if (!empty($supportPage[1]->section_content) && $supportPage[1]->section_content !== '#')
                                <div class="w-auto p-5">
                                    <a class="text-gray-900" href="{{ __($supportPage[1]->section_content) }}"
                                        target="_blank">
                            ...
                            @if (!empty($supportPage[2]->section_content) && $supportPage[2]->section_content !== '#')
                                <div class="w-auto p-5">
                                    <a class="text-gray-900" href="{{ __($supportPage[2]->section_content) }}"
                                        target="_blank">
                            ...
                            @if (!empty($supportPage[3]->section_content) && $supportPage[3]->section_content !== '#')
                                <div class="w-auto p-5">
                                    <a class="text-gray-900" href="{{ __($supportPage[3]->section_content) }}"
                                        target="_blank">

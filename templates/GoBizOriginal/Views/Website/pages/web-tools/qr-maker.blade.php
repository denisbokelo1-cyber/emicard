@extends('GoBizOriginal::Website.layouts.index', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('QR Code Maker - Web Tools')])
            ...
            <div class="max-w-full mx-auto py-6">
                ...
                <div class="mt-8 p-6 bg-gray-100 rounded-lg shadow-md">
                    ...
                    <div class="flex flex-col items-center justify-center mt-4">
                        ...
                        <button id="download"
                            class="mt-4 px-4 py-2 text-white font-medium rounded-lg shadow bg-gradient-to-r from-{{ $template_config->template_color }}-400 to-{{ $template_config->template_color }}-500 transition">
                            {{ __('Download QR') }}
                        </button>
                    </div>
                </div>

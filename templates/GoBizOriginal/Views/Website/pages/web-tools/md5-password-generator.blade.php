    ...
    <section class="text-gray-700">
        <div class="container px-5 py-12 mx-auto">
            ...
            <form action="{{ route('web.result.md5.password.generator')}}" method="post">
                ...
                <button type="submit" class="group relative font-heading px-10 py-5 mb-8 w-full lg:w-auto uppercase text-white text-xs font-semibold tracking-px bg-gradient-to-r from-{{ $template_config->template_color }}-400 to-{{ $template_config->template_color }}-500 overflow-hidden rounded-md" onclick="convert()">{{ __('Generate') }}</button>
            </form>

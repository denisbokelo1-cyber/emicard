        ...
        <div class="container-fluid">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        <span class="me-1">{{ __($page->section_name) }}</span>
                        {{ __('Details') }}
                    </h2>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row row-deck row-cards">
                ...
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('admin.web-template.gobiz-original.update-custom-page') }}" method="post" enctype="multipart/form-data"
...
tinymce.init({
    ...
    plugins: 'code image preview importcss searchreplace autolink autosave save directionality visualblocks visualchars link charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount charmap quickbars emoticons',
    menubar: 'file edit view insert format tools',
    toolbar: 'code undo redo | image bold italic underline strikethrough | fontfamily fontsize blocks | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist | forecolor backcolor removeformat | pagebreak | charmap emoticons | preview save print | insertfile link anchor | ltr rtl',

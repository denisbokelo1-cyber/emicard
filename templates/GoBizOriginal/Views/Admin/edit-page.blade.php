        ...
        <div class="container-fluid">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        <span class="me-1 text-capitalize">{{ __($sections[0]->page_name) }}</span>
                        {{ __('Details') }}
                    </h2>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row row-deck row-cards">
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('admin.web-template.gobiz-original.update-page', Request::segment(6)) }}" method="post"
                                ...
                                @for ($i = 0; $i < count($sections); $i++) <div class="col-xl-6">
                                    <div id="section{{ $i }}" class="row">
                                        <div class="col-md-12 col-xl-12">
                                            <div class="mb-3">
                                                <label class="form-label required">{{ __($sections[$i]->section_title == "desc" ? 'Description' : str_replace('_', ' ', $sections[$i]->section_title)) }}</label>

            ...
            <div class="container-fluid">
                <div class="row align-items-center g-2">
                    ...
                    <div class="col">
                        ...
                        <h2 class="page-title">{{ __('Business Card Intros') }}</h2>
                    </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item {{ $status == 'all' ? 'active' : '' }}"
                                    href="{{ route('admin.business-card-intros') }}">
                                    {{ __('All') }}
                                </a>
                                <a class="dropdown-item {{ $status == 'active' ? 'active' : '' }}"
                                    href="{{ route('admin.business-card-intros') }}?status=active">
                                    {{ __('Active') }}
                                </a>
                                <a class="dropdown-item {{ $status == 'disabled' ? 'active' : '' }}"
                                    href="{{ route('admin.business-card-intros') }}?status=disabled">
                                    {{ __('Disabled') }}
                                </a>
                            </div>
                        </div>
                        ...
                        @foreach ($intros as $intro)
                            <div class="col-6 col-sm-4 col-md-2">
                                <div class="card card-sm">
                                    {{-- Thumbnail --}}
                                    <img src="{{ asset('img/intros/' . $intro['intro_thumbnail']) }}" class="card-img-top">

                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            @php
                                                $string = $intro['intro_name'];
                                                $words = explode(' ', $string);
                                                $introName = implode(' ', array_slice($words, 0, 3));
                                                if (count($words) > 3) {
                                                    $introName = implode(' ', array_slice($words, 0, 3)) . ' ...';
                                                }
                                            @endphp
                                            <div class="col">
                                                <div>
                                                    <strong class="one-line-ellipsis">{{ __($introName) }}</strong>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-auto">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <a href="{{ route('admin.edit.business-card-intro', $intro['business_card_intro_id']) }}"
                                                            class="dropdown-item">
                                                            {{ __('Edit') }}
                                                        </a>
                                                        @if ($intro->status == '0')
                                                            <a href="{{ route('admin.business-card-intro.status', $intro['business_card_intro_id']) }}"
                                                                class="dropdown-item">
                                                                {{ __('Enable') }}
                                                            </a>
                                                        @else

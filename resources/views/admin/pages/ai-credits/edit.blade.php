            ...
            <div class="container-fluid">
                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('admin.update.ai.credits.plan', $aiCreditsPlan->ai_credits_plan_id) }}"
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="plan_name"
                                                        value="{{ old('plan_name', $aiCreditsPlan->plan_name) }}"
                                                        placeholder="{{ __('Plan Name') }}" minlength="3" maxlength="255"
                                                        required>
                                                </div>
                                            </div>
                                            {{-- Plan Description --}}
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="plan_description" placeholder="{{ __('Plan Description') }}" minlength="10"
                                                        maxlength="255" required>{{ old('plan_description', $aiCreditsPlan->plan_description) }}</textarea>
                                                </div>
                                            </div>
                                            {{-- Plan Price --}}
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="plan_price"
                                                        value="{{ old('plan_price', $aiCreditsPlan->plan_price) }}"
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="no_of_ai_credits"
                                                        value="{{ old('no_of_ai_credits', $aiCreditsPlan->no_of_ai_credits) }}"

                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-xl-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="js-editor" name="js" placeholder="{{ __("Example: document.addEventListener('DOMContentLoaded', function() { console.log('Hello'); });") }}">{{ trim($themeDetails->theme_js) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>

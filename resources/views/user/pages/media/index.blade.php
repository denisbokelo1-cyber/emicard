                    ...
                    <div class="col-sm-4 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="h1 mb-3">
                                    {{ __($active_plan->storage == '999' ? 'Unlimited' : $totalStorage . ' MB') }}</div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress progress-md">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger"
                                        style="width: {{ $usedStoragePercentage }}%" role="progressbar"
                                        aria-valuenow="{{ $usedStorage }}" aria-valuemin="0" aria-valuemax="100"
                                        aria-label="{{ $usedStoragePercentage }}% Complete">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if ($active_plan->storage == '999')
                                    <div class="h1 mb-3">{{ __('Unlimited') }}</div>
                                    <div class="progress progress-md">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                            style="width: {{ $availableStoragePercentage }}%" role="progressbar"
                                            aria-valuenow="{{ $availableStorage }}" aria-valuemin="0" aria-valuemax="100"
                                            aria-label="{{ $availableStoragePercentage }}% Complete">
                                        </div>
                                    </div>
                                @else
                                    ...
                                    <div class="progress progress-md">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                            ...
                                            aria-valuenow="{{ $availableStorage }}" aria-valuemin="0" aria-valuemax="100"
                                            aria-label="{{ $availableStoragePercentage }}% Complete">
                                            <span class="visually-hidden">{{ $availableStoragePercentage }}%
                                                Complete</span>
                                        </div>
                                    </div>
                                @endif
...
@section('scripts')
                ...
                mediaCardsHtml += `
                    <div class="col-md-3 col-lg-3 mb-3">
                        <div class="card h-100">
                            <a href="${media.base_url}${media.media_url}" data-fslightbox="gallery">
                                <div class="card-img-top ratio ratio-1x1"
                                    style="background-image: url('${media.base_url}${media.media_url}');
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <div class="text-secondary">${media.size}</div>
                                        <div class="text-secondary">${media.formatted_created_at}</div>
                                    </div>

                                    <div class="ms-auto d-flex gap-2">
                                        <a href="#" class="btn btn-outline-primary btn-icon" onclick="copyMedia('${media.media_url}')" data-bs-toggle="tooltip" title="Copy">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-copy"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><rect x="8" y="8" width="12" height="12" rx="2" /><path d="M16 8v-2a2 2 0 0 0 -2 -2h-8a2 2 0 0 0 -2 2v8a2 2 0 0 0 2 2h2" /></svg>
                                        </a>
    ...
    <script>
        ...
        function copyMedia(url) {
            ...
            alertDiv.classList.add('alert', 'alert-important', 'alert-success', 'alert-dismissible');
            alertDiv.setAttribute('role', 'alert');

            var innerContent = '<div class="d-flex">' +
                '<div>' +
                '{{ __('Image path was copied.') }}' +
                '</div>' +
                '</div>' +

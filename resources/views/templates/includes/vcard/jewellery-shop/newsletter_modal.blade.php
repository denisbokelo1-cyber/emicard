@php
    ...
    $nl_title = $newsletter_pop->title ?? __('The Inner Circle');
    $nl_desc =
        $newsletter_pop->description ??
        __('Subscribe for early access to new collections and exclusive high-jewelry event invitations.');
...
<div id="newsletterModal" data-csrf="{{ csrf_token() }}" data-email-error="{{ __('Please enter your email.') }}"
    ...
    <div id="customNewsBox">
        ...
        <div class="custom-news-icon-wrap">
            <i class="far fa-envelope custom-news-icon"></i>
        </div>

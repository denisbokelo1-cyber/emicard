...
!(function (e, t) {
    ...
    function Lt(e) {
        ...
        ((this._isValid = (function (e) {
            ...
            for (t in e)
                if (
                    r(e, t) &&
                    (-1 === Oe.call(Ft, t) || (null != e[t] && isNaN(e[t])))
                )
                    return !1;
            for (n = 0; n < i; ++n)
                if (e[Ft[n]]) {
    ...
    function It(e, t) {
        ...
        return t._isUTC
            ? ((s = t.clone()),
              (i =
                  (v(e) || l(e) ? e.valueOf() : Rt(e).valueOf()) - s.valueOf()),
    ...
    ((bn.add = en),
        ...
        (bn.diff = function (e, t, n) {
            ...
            switch (
                ((i = 6e4 * (s.utcOffset() - this.utcOffset())), (t = L(t)))
            ) {
                case "year":
                    r = rn(this, s) / 12;
                    break;
                ...
                var n,
                    s = (function (e) {
                        var t,
                            n = [];
                        for (t in e)
                            r(e, t) && n.push({ unit: t, priority: G[t] });
                        return (
                            n.sort(function (e, t) {
